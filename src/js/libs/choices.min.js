...
!(function (e, t) {
  ...
  var s,
    ...
    I = function (e, t, i) {
      return (
        void 0 === i && (i = 1),
        i > 0 ? t.scrollTop + t.offsetHeight >= e.offsetTop + e.offsetHeight : e.offsetTop >= t.scrollTop
      );
    },
    A = function (e) {
      if ("string" != typeof e) {
      ...
      return (
        ...
        (e.prototype.open = function (e, t) {
          (R(this.element, this.classNames.openState),
            this.element.setAttribute("aria-expanded", "true"),
            (this.isOpen = !0),
            this.shouldFlip(e, t) && (R(this.element, this.classNames.flippedState), (this.isFlipped = !0)));
        }),
        (e.prototype.close = function () {
          (K(this.element, this.classNames.openState),
            ...
            (this.isOpen = !1),
            this.isFlipped && (K(this.element, this.classNames.flippedState), (this.isFlipped = !1)));
        }),
        ...
        (e.prototype.setWidth = function () {
          ...
          if (t || i) {
            ...
            (Number.isNaN(r)
              ...
              : (i && ((o.innerText = i), (n = parseFloat(getComputedStyle(o).width) / r)),
                t && ((o.innerText = t), (s = parseFloat(getComputedStyle(o).width) / r))),
              o.remove());
          }
    ...
    W = (function () {
      ...
      return (
        ...
        (e.prototype.reveal = function () {
          var e = this.element;
          (K(e, this.classNames.input), (e.hidden = !1), e.removeAttribute("tabindex"));
        ...
        (e.prototype.triggerEvent = function (e, t) {
          var i;
          (void 0 === (i = t || {}) && (i = null),
            this.element.dispatchEvent(new CustomEvent(e, { detail: i, bubbles: !0, cancelable: !0 })));
        }),
        e
      );
    })(),
    ...
    J = function (e, t, i) {
      if ((void 0 === i && (i = !0), "string" == typeof e)) {
        var n = A(e);
        return J({ value: e, label: i || n === e ? e : { escaped: n, raw: e }, selected: !0 }, !1);
      }
      var s = e;
      if ("choices" in s) {
      ...
      return (
        ...
        (i.prototype.optionsAsChoices = function () {
          var e = this,
            t = [];
          return (
            this.element.querySelectorAll(":scope > option, :scope > optgroup").forEach(function (i) {
              !(function (e) {
        ...
        (i.prototype._optionToChoice = function (e) {
          return (
              ...
              (e.setAttribute("value", ""), (e.value = "")),
            {
              ...
              labelClass: void 0 !== e.dataset.labelClass ? z(e.dataset.labelClass) : void 0,
              labelDescription:
                void 0 !== e.dataset.labelDescription ? { trusted: e.dataset.labelDescription } : void 0,
  ...
  function ye(e) {
    ...
    if (he(e) || ae(e)) ((n = e), (t = be(e)), (i = Ee(e)));
      ...
      const r = e.name;
      if (((n = r), ge.call(e, "weight") && ((s = e.weight), s <= 0))) throw new Error(ve(r));
  ...
  const we = /[^ ]+/g;
  class Ie {
    constructor({ getFn: e = Ce.getFn, fieldNormWeight: t = Ce.fieldNormWeight } = {}) {
  ...
  function Ae(e, t, { getFn: i = Ce.getFn, fieldNormWeight: n = Ce.fieldNormWeight } = {}) {
    ...
    searchIn(e) {
      ...
      this.chunks.forEach(({ pattern: t, alphabet: d, startIndex: p }) => {
        const {
          ...
          if (t.length > Oe) throw new Error("Pattern length exceeds max of 32.");
          const l = t.length,
            u = e.length,
          ...
          for (; (g = e.indexOf(t, f)) > -1; ) {
            let e = xe(t, { currentLocation: g, expectedLocation: d, distance: s, ignoreLocation: h });
  ...
  class ze {
    ...
    setCollection(e, t) {
      if (((this._docs = e), t && !(t instanceof Ie))) throw new Error("Incorrect 'index' type");
      this._myIndex =
        t ||
    ...
    search(e, { limit: t = -1 } = {}) {
      ...
      return (
        ...
        (function (e, t, { includeMatches: i = Ce.includeMatches, includeScore: n = Ce.includeScore } = {}) {
          const s = [];
          return (
            i && s.push(Ue),
            n && s.push(Ge),
  ...
  ((ze.version = "7.0.0"),
    (ze.createIndex = Ae),
    (ze.parseIndex = function (e, { getFn: t = Ce.getFn, fieldNormWeight: i = Ce.fieldNormWeight } = {}) {
        ...
        searchIn(e) {
          ...
          for (let n = 0, c = t.length; n < c; n += 1) {
            ...
            for (let t = 0, n = c.length; t < n; t += 1) {
              ...
              ((s += 1), (r += l), i && (Re.has(n.constructor.type) ? (o = [...o, ...h]) : o.push(h)));
            }
            if (s) {
  ...
  var Je = (function () {
      ...
      return (
        ...
        (e.prototype.search = function (e) {
          return (
            this._fuse || (this._fuse = new ze(this._haystack, this._fuseOptions)),
    ...
    Ye = {
      ...
      itemList: function (e, t) {
        ...
        return (R(c, s), R(c, t ? o : r), this._isSelectElement && i && c.setAttribute("role", "listbox"), c);
      },
      ...
      choice: function (e, t, i, n) {
        ...
        ((m.id = t.elementId),
          R(m, r),
          R(m, c),
          n && "string" == typeof p && ((p = k(s, p)), (p = { trusted: (p += " (".concat(n, ")")) })));
        var v = m;
        if (t.labelClass) {
        ...
        return (
          ...
          Xe(m, t, !1),
          t.disabled
            ? (R(m, l), (m.dataset.choiceDisabled = ""), m.setAttribute("aria-disabled", "true"))
            : (R(m, a),
      ...
      input: function (e, t) {
        ...
        return (
          ...
          t ? r.setAttribute("aria-label", t) : o || Qe(this._docRoot, this.passedElement.element.id, r),
          r
        );
      },
      dropdown: function (e) {
      ...
      notice: function (e, t, i) {
        ...
        return (i === se && ((l.dataset.choiceSelectable = ""), (l.dataset.choice = "")), l);
      },
      option: function (e) {
        var t = L(e.label),
          i = new Option(t, e.value, !1, e.selected);
        return (Xe(i, e, !0), (i.disabled = e.disabled), e.selected && i.setAttribute("selected", ""), i);
      },
    },
    Ze =
  ...
  return (function () {
    function e(t, n) {
      ...
      if (
        ...
        return (
          r.silent ||
            console.warn("Trying to initialise Choices on element already initialised", { element: t }),
          (this.initialised = !0),
    ...
    return (
      ...
      (e.prototype.highlightItem = function (e, t) {
        ...
        return (
          !i ||
            i.highlighted ||
            (this._store.dispatch(C(i, !0)), t && this.passedElement.triggerEvent(v, T(i))),
          this
        );
      }),
        ...
        return (
          this._store.withTxn(function () {
            e._store.items.forEach(function (t) {
              t.highlighted || (e._store.dispatch(C(t, !0)), e.passedElement.triggerEvent(v, T(t)));
            });
          }),
          this
        );
      ...
      (e.prototype.unhighlightAll = function () {
        ...
        return (
          this._store.withTxn(function () {
            e._store.items.forEach(function (t) {
              t.highlighted && (e._store.dispatch(C(t, !1)), e.passedElement.triggerEvent(v, T(t)));
            });
          }),
          this
        );
        ...
        return (
          this.dropdown.isActive ||
            ...
            requestAnimationFrame(function () {
              ...
              var n = t.choiceList.element.querySelector(j(t.config.classNames.selectedState));
              null === n || I(n, t.choiceList.element) || (t.choiceList.element.scrollTop = n.offsetTop);
            })),
          this
        );
      }),
        ...
        return (
          ...
          this._store.withTxn(function () {
            ...
            (e.forEach(function (e) {
              if ("choices" in e) {
                var s = e;
                (h || (s = i(i({}, s), { label: s[n] })), c._addGroup(J(s, !0)));
              } else {
                var o = e;
          ...
          this.dropdown.isActive && this._canAddUserChoices && this._canCreateItem(this.input.value),
          this._searcher.reset(),
          this
        );
      }),
        ...
        return (
          ...
          e &&
            (t
              ...
              : this.passedElement.element.querySelectorAll(":not([selected])").forEach(function (e) {
                  e.remove();
                })),
        ...
        if (this._canAddItems()) {
            ...
            p = function (n, s) {
              ...
              ((o = !s && r > 0 && o > r ? r : o),
                ...
                n.every(function (n, s) {
                  var r =
                    n.choiceEl ||
                    e._templates.choice(t, n, t.itemSelectText, l && n.group ? n.group.label : void 0);
                  return (
                    (n.choiceEl = r),
                    a.appendChild(r),
          ...
          (o.length &&
            ...
            s.length && !i
              ? (t.shouldSort && s.sort(t.sorter),
                ...
                s.forEach(function (t) {
                  ...
                  if (i.length) {
                    if (t.label) {
                      var n = t.groupEl || e._templates.choiceGroup(e.config, t);
            ...
            u ||
              ...
              (this._notice ||
                (this._notice = { text: O(i ? t.noResultsText : t.noChoicesText), type: i ? ne : ie }),
              a.replaceChildren("")),
      ...
      (e.prototype._renderItems = function () {
        var e = this,
          ...
          r = function (t) {
            var i = t.itemEl;
            (i && i.parentElement) ||
              ((i = o(t) || e._templates.item(n, t, n.removeItemButton)), (t.itemEl = i), s.appendChild(i));
          };
        t.forEach(r);
        ...
        if (this._isSelectOneElement) {
          ...
          if (c || a > 1) {
            ...
            c ||
              ...
              ((c = !0),
              r(J({ selected: !0, value: "", label: this._placeholderValue, placeholder: !0 }, !1)));
        }
        (c &&
          (i.append(s),
          n.shouldSortItems &&
      ...
      (e.prototype._displayNotice = function (e, t, i) {
        void 0 === i && (i = !0);
        var n = this._notice;
        n && ((n.type === t && n.text === e) || (n.type === se && (t === ne || t === ie)))
      ...
      (e.prototype._clearNotice = function () {
        if (this._notice) {
          var e = this.choiceList.element.querySelector(j(this.config.classNames.notice));
      ...
      (e.prototype._canAddItems = function () {
        ...
        return !e.singleModeForMultiSelect && t > 0 && t <= this._store.items.length
          ? (this.choiceList.element.replaceChildren(""),
            ...
            !1)
          : (this._notice && this._notice.type === se && this._clearNotice(), !0);
      }),
      (e.prototype._canCreateItem = function (e) {
        ...
        if (
          ...
          t.duplicateItemsAllowed || ((i = !1), (n = N(t.uniqueItemText, e, void 0)));
        }
        return (i && (n = N(t.addItemText, e, void 0)), n && this._displayNotice(n, se), i);
      }),
      (e.prototype._searchChoices = function (e) {
        ...
        return (
          (s && s.type) !== se &&
            (n.length ? this._clearNotice() : this._displayNotice(O(this.config.noResultsText), ne)),
          this._store.dispatch(
            (function (e) {
      ...
      (e.prototype._removeEventListeners = function () {
        ...
        (e.removeEventListener("touchend", this._onTouchEnd, !0),
          ...
          this._isSelectOneElement &&
            (t.removeEventListener("focus", this._onFocus), t.removeEventListener("blur", this._onBlur)),
      ...
      (e.prototype._onEnterKey = function (e, t) {
        ...
        if ((e.preventDefault(), s && s.hasAttribute("data-button"))) this._handleButtonAction(s);
          ...
          var o = this.dropdown.element.querySelector(j(this.config.classNames.highlightedState));
              ...
              if (this._canAddItems()) {
                ...
                (this._store.withTxn(function () {
                  if (!(r = i._findAndSelectChoiceByValue(n, !0))) {
                    ...
                    (i._addChoice(J(n, !1, i.config.allowHtmlUserInput), !0, !0), (r = !0));
                  }
      ...
      (e.prototype._onDirectionKey = function (e, t) {
        ...
        if (t || this._isSelectOneElement) {
          ...
          if (e.metaKey || 34 === i || 33 === i)
            s = this.dropdown.element.querySelector(n > 0 ? "".concat(it, ":last-of-type") : it);
          else {
            var o = this.dropdown.element.querySelector(j(this.config.classNames.highlightedState));
            s = o
              ? (function (e, t, i) {
          ...
          (s &&
            (I(s, this.choiceList.element, n) || this.choiceList.scrollToChildElement(s, n),
      ...
      (e.prototype._onBlur = function (e) {
        ...
        t && i.element.contains(t) && !this._isScrollingOnIe
          ? t === this.input.element
            ...
            : t === this.containerOuter.element &&
              (i.removeFocusState(), this.config.searchEnabled || this.hideDropdown(!0))
      ...
      (e.prototype._removeHighlightedChoices = function () {
        ...
        Array.from(this.dropdown.element.querySelectorAll(j(e))).forEach(function (t) {
        ...
        if (t.length) {
          ...
          (this._removeHighlightedChoices(),
            i
              ...
              : (i = t.length > this._highlightPosition ? t[this._highlightPosition] : t[t.length - 1]) ||
                (i = t[0]),
            R(i, n),
      ...
      (e.prototype._addItem = function (e, t, i) {
        ...
        if (
          ...
          var n = T(e);
          (this.passedElement.triggerEvent("addItem", n), i && this.passedElement.triggerEvent("choice", n));
        }
      }),
      (e.prototype._removeItem = function (e) {
        if (e.id) {
          ...
          var t = this._notice;
          (t && t.type === ie && this._clearNotice(), this.passedElement.triggerEvent(m, T(e)));
        }
      }),
      ...
      (e.prototype._createElements = function () {
        ...
        ((this.containerOuter = new H({
          ...
          (this.dropdown = new B({ element: e.dropdown(t), classNames: s, type: o })));
      }),
      ...
      (e.prototype._initStore = function () {
        ...
        (this._store.subscribe(this._render).withTxn(function () {
          ...
          (!this._store.choices.length || (this._isSelectOneElement && this._hasNonChoicePlaceholder)) &&
            this._render());
      }),
      ...
      (e.prototype._warnChoicesInitFailed = function (e) {
        if (!this.config.silent) {
          ...
          if (!this.initialisedOK)
            throw new TypeError(
              "".concat(e, " called for an element which has multiple instances of Choices initialised on it")
            );
        }
      }),
      (e.version = "11.2.3"),
